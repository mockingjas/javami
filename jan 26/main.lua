...
--for row in db:nrows("PRAGMA table_info(ThirdGameAnalytics);") do print(row.name) end
...
--for row in db:nrows("SELECT * FROM ThirdGameAnalytics") do	print(row.id..row.roundnumber..row.score..row.speed) end
